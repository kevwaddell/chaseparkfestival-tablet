...
<div id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form name="resetpassform" id="resetpassform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'resetpass', 'login_post' ); ?>" method="post" autocomplete="off">
		...
		<div class="user-pass1-wrap">
			...
			<div class="orm-group wp-pwd">
				<span class="password-input-wrapper">
					<input type="password" data-reveal="1" data-pw="<?php echo esc_attr( wp_generate_password( 16 ) ); ?>" name="pass1" id="pass1" class="input-lg form-control text-center" size="20" value="" autocomplete="off" aria-describedby="pass-strength-result" />
				</span>
		...
		<div class="form-group user-pass2-wrap">
			...
			<input type="password" name="pass2" id="pass2" class="input-lg form-control text-center" size="20" value="" autocomplete="off" />
		</div>
		...
		<div class="form-group">
			<input type="submit" name="wp-submit" class="submit-btn btn btn-default btn-block btn-lg tk-azo-sans-uber" id="wp-submit<?php $template->the_instance(); ?>" value="<?php esc_attr_e( 'Reset Password', 'theme-my-login' ); ?>" />
	...
	<a href="<?php echo get_option('home'); ?>/" class="btn btn-default btn-block back-btn">Back to main site</a>
</div>
