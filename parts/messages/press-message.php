...
<div class="container">
	<div class="no-content-message text-center">
		...
		<figure class="message-img in-block">
			<img src="<?php bloginfo('stylesheet_directory'); ?>/_/img/press-message-img.png" class="img-responsive" />
		</figure>
		
		<h1 class="text-uppercase txt-col-orange tk-azo-sans-uber">Press <?php echo $year; ?></h1>
		
		<p>Press for <span class="txt-col-orange">Chase Park Festival</span> will be available soon.</p>
