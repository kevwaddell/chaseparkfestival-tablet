...
<div class="container-fluid">
	<div class="no-content-message text-center">
		...
		<h1 class="text-uppercase txt-col-orange tk-azo-sans-uber">Sponsorship for <?php echo $this_year; ?></h1>
		
		<p>Sponsorship details for <span class="txt-col-orange">Chase Park Festival</span> will be available soon.</p>
